          ...
          <Card noTilt className="p-5 border-purple-500/30 bg-[#0c1728]/90">
            ...
            <div className="grid grid-cols-3 gap-2 font-mono text-xs text-[#cbd5e1]">
              <div className="bg-black/40 p-2.5 rounded-xl border border-white/5">
                <small className="text-[#94a3b8] block text-[10px] font-sans">Battery</small>
                <b className="text-white flex items-center gap-1">
                  <BatteryMedium className="w-3.5 h-3.5 text-[#22c55e]" /> 74%
                </b>
              </div>
              <div className="bg-black/40 p-2.5 rounded-xl border border-white/5">
                <small className="text-[#94a3b8] block text-[10px] font-sans">Location</small>
                <b className="text-[#00d9d9]">Granted</b>
              </div>
              <div className="bg-black/40 p-2.5 rounded-xl border border-white/5">
                <small className="text-[#94a3b8] block text-[10px] font-sans">Network</small>
                <b className="text-[#22c55e] flex items-center gap-1">
